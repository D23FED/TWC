	...
	<div class="share">
		...
		<div class="share-emailPrint">
		    <?php
					if(($printButton) || !isset($printButton))
					 echo '<div class="cta omega share twc-icon-before icon-print">
            ...
            echo '<div id="email" class="cta omega share twc-icon-before icon-envelope-alt">
                	<a href="">
    	...
    	<?php if(($twitterButton) || !isset($twitterButton))
					echo '<div class="cta omega share twc-icon-only icon-twitter">
				<a id="twitter">
				    <span></span>
				</a>
		    </div>'
      ...
      <?php if(($facebookButton) || !isset($facebookButton))
					echo '<div class="cta omega share twc-icon-only icon-facebook">
				<a id="facebook">
				    <span></span>
				</a>
		    </div>'
      ...
      <?php if(($linkedInButton) || !isset($linkedInButton))
					echo ' <div class="cta omega share twc-icon-only icon-linkedin">
						<a id="linkedin">
				    	<span></span>
					</a>
		    </div>'
