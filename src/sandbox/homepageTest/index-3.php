        ...
        <li>
          <div class="clickIcon offPage">
            <a href="">
              ...
              <span class="mobile-hidden">Upgrade</span>
  ...
  <div class="twc-container">
    <ul class="twc-new-nav">
      <li class="nav-menu-1">
        ...
        <a href="" class="tablet-hidden" onclick="return false">Discover TWC&reg;</a>
        <ul>
          <li>
                    ...
                    <div class="parbase section">
                      <div class="labelList section">
                        ...
                        <ul>
                          ...
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Service on Your Terms</a>
                            </div>
                          </li>
                        </ul>
                      </div>
      ...
      <li class="nav-menu-2">
        ...
        <label for="mobile-menu-two" class="desktop-hidden">All Plans</label>
              ...
              <div class="20-20-20-20-20 section columnControl">
                <div class="parsys_column twc-col5_2020202020 marginless">
                  <div class="parsys parsys0 twc-col5_2020202020-c0 parsys_column">
                    <div class="parbase section">
                      <div class="labelList section">
                        <h4 class="label">PACKAGES</h4>
                        <ul>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">All Plans &amp; Prices</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Pick Your Plans</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                    ...
                    <div class="parbase section">
                      <div class="labelList section">
                        ...
                        <ul>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">TV Plans &amp; Pricing</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Learn About TV</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Premium Networks</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Sports Plans</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                    ...
                    <div class="parbase section">
                      <div class="labelList section">
                        ...
                        <ul>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Internet Plans &amp; Pricing</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Discover Internet</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                    ...
                    <div class="parbase section">
                      <div class="labelList section">
                        ...
                        <ul>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Phone Plans &amp; Pricing</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Explore Phone</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">International One Price</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Global Penny Plan</a>
                            </div>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="parbase section">
                      <div class="labelList section">
                        ...
                        <ul>
                          ...
                          <li>
                            <div class="smartLink parbase">
                              <a href="">Research Home Security</a>
                            </div>
                          </li>
                          <li>
                            <div class="smartLink parbase">
      ...
      <li class="nav-menu-3 tablet-hidden">
        ...
        <ul>
          <li>
            <div class="parbase teaser twc-new-mega-section width-twentyFive">
              <div class="parbase section">
                <div class="labelList section">
                  <ul>
                    <h4>WATCH TV</h4>
...
<div class="twc-content">
  ...
  <div class="offerBar">
    <div class="twc-container">
      <div class="text-center">
        ...
        <strong class="h5">TV + Internet + Phone</strong><span class="h6">&nbsp;plans starting at&nbsp;</span><strong class="h5">$89.99</strong>/mo.
        </span>
        <div class="cta white icon-after icon-angle-right inline">
          <a href="#">
 ...
 <div id="hphero" class="image imageArtDirection image-focus-3 parbase image-focus-bottom mob-image-focus-2 section">
    <div style="background-image: url(images/hp-banner-background.jpg); height: auto;" class="image-focus-3 image-focus-bottom mob-image-focus-2">
        <div class="parsys twc-container art-direction-par">
            <div class="twc-container">
                <div class="100 section columnControl">
                  <div class="parsys_column twc-col1_100-c0">
                    <div class="parsys parsys0 twc-col100_1-c0 parsys_column internal">
                      <div class="parbase section">
                            <div class="heroContainer">
                            <h1 class="super-h1">TWC. It's on!</h1>
                              <p class="fs-22 light">More HD channels, faster internet, unlimited phone. 24/7 home security<br class="tablet-hidden"> and 1-hour service windows.</p>
                              <hr class="spacer">
                              <div class="cta twc-icon-after horizontal-center parbase smartLink icon-angle-right section non-indented fs-19">
                                <a href="#">
                                  <span class="link-label">Discover TWC</span>
                                </a>
                              </div>
                            </div>
                      </div>
    ...
    <div class="25-25-25-25 section columnControl">
      <div class="parsys_column twc-col4_25252525 marginless">
        <div class="parsys parsys0 twc-col4_25252525-c0 parsys_column">
          <div class="parbase section">
            <div class="offerStripContainer">
              <h6 class="text-center fs22">Internet</h6>
              <div class="pricing text-center">
                ...
                <span class="term">Per mo. /<br>12 mos.</span>
              </div>
        ...
        <div class="parsys parsys1 twc-col4_25252525-c1 parsys_column">
          <div class="parbase section">
            <div class="offerStripContainer">
              <h6 class="text-center fs22">TV + Internet</h6>
              <div class="pricing text-center">
                <p>As Low As</p>
                <span class="h4">
                  <sup class="dollar-sign">$</sup>
        ...
        <div class="parsys parsys1 twc-col4_25252525-c3 parsys_column">
          <div class="parbase section text-center">
            ...
            <div class="offerStripContainer">
              <h6 class="text-center fs22">Get a $300 Reward Card</h6>
              <hr class="spacer">
              <div class="pricing">
            <figure><img src="http://www.timewarnercable.com/content/dam/residential/specials-ola/images/061815_ny_reward_card/rewards-card.png" style="max-height: 35px;"></figure>
          </div>
              <div class="cta flatOmega icon-after icon-angle-right">
                <a href="#">
  ...
  <div class="flyoutContainer">
    <div class="twc-container">
      ...
      <hr class="spacer">
      <div class="clear"></div>
        <span class="h1">TWC Products and Services</span>
        <div class="clear"></div>
        <hr class="spacer">
      </div>
      <div class="20-20-20-20-20 section columnControl">
          ...
          <div class="parsys parsys0 twc-col5_2020202020-c0 parsys_column">
            <div class="parbase section">
              ...
              <div class="flyout">
                   ...
                   <div class="cta omegaWhite twc-icon-after icon-angle-right fs-18">
                    <a analyticsname="test" href="#">
                        <span>Internet</span>
                    </a>
                  </div>
                  ...
                  <div>
                      <div class="vertical">
                          <ul>
                                <li class="js-first">
                                  <a href="">
                                      <span class="fs-16">Learn About Internet</span>
                                  </a>
                              </li>
                              <li>
                                  <a href="">
                                      <span class="fs-16">Equipment Options</span>
                                  </a>
                              </li>
                              <li class="js-last">
                                  <a href="">
                                      <span class="fs-16">Test Your Speed</span>
                                  </a>
                              </li>
                          </ul>
                      </div>
            ...
            <div class="parbase section">
              ...
              <div class="flyout">
                    <div class="flyoutIcon">
                        <figure>
                            <a analyticsname="test" href="#">
                                <img alt="Internet" src="images/explore-tv.jpg">
                            </a>
                        </figure>
                    </div>
                    <div class="cta omegaWhite twc-icon-after icon-angle-right fs-18">
                  ...
                  <div >
                      <div class="vertical">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span class="fs-16">Learn About TV</span>
                                  </a>
                              </li>
                              <li>
                                  <a href="">
                                      <span class="fs-16">Premium Networks</span>
                                  </a>
                              </li>
                              <li class="js-last">
                                  <a href="">
                                      <span class="fs-16">Channel Lineups</span>
                                  </a>
                              </li>
                          </ul>
                      </div>
            ...
            <div class="parbase section">
              ...
              <div class="flyout">
                  <div class="flyoutIcon">
                        <figure>
                            <a analyticsname="test" href="#">
                                <img alt="Improved Service" src="images/check-icon.png">
                            </a>
                        </figure>
                    </div>
                    <div class="cta omegaWhite twc-icon-after icon-angle-right fs-18">
                  ...
                  <div >
                      <div class="vertical">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span class="fs-16">Commitment to Service</span>
                                  </a>
                              </li>
                              <li>
                                  <a href="">
                                      <span class="fs-16">Call or Chat with Us</span>
                                  </a>
                              </li>
                              <li class="js-last">
                                  <a href="">
                                      <span class="fs-16">TWC Store Locations</span>
                                  </a>
                              </li>
                          </ul>
                      </div>
            ...
            <div class="parbase section">
              ...
              <div class="flyout">
                  <div class="flyoutIcon">
                        <figure>
                            <a analyticsname="test" href="#">
                                <img alt="Phone" src="images/explore-phone.jpg">
                            </a>
                        </figure>
                    </div>
                    <div class="cta omegaWhite twc-icon-after icon-angle-right fs-18">
                  ...
                  <div >
                      <div class="vertical ">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span class="fs-16">Learn About Phone</span>
                                  </a>
                              </li>

                              <li>
                                  <a href="">
                                      <span class="fs-16">International Calling</span>
                                  </a>
                              </li>
                              <li class="js-last">
                                  <a href="">
                                      <span class="fs-16">Popular Calling Features</span>
                                  </a>
                              </li>
                          </ul>
                      </div>
            ...
            <div class="parbase section">
              ...
              <div class="flyout">
                <div class="flyoutIcon">
                        <figure>
                            <a analyticsname="test" href="#">
                                <img alt="Intelligent Home" src="images/explore-home-security.jpg">
                            </a>
                        </figure>
                    </div>
                  <div class="cta omegaWhite twc-icon-after icon-angle-right fs-18">
                  ...
                  <div>
                      <div class="vertical">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span class="fs-16">Research Home Management</span>
                                  </a>
                              </li>
                              <li>
                                  <a href="">
                                      <span class="fs-16">Equipment Packages</span>
                                  </a>
                              </li>
                              <li class="js-last">
                                  <a href="">
                        ...
                        <div class="richtext section">
                            ...
                            <div class="block text-center">
                                <figure class="desktop-hidden">
                                  <img src="images/pinwheel.png" alt="Watch TV anytime, anywhere">
                                </figure>
                                 <p class="h1">Watch TV anytime, anywhere with apps</p>
                                 <div class="clear"></div>
                                <hr class="spacer tablet-hidden">
                                ...
                                <a href="/en/apps.html?iid=tv-lob:3:1:tvapps" analyticsname="tv-lob:4:2:learn about our tv apps">
                                    <span>See All Available Apps</span>
                                </a>
                                <hr class="spacer desktop-hidden">
                                <div class="clear"></div>
                                </div>
  ...
  <div class="parsys_column twc-col6_151515151515">
    <div class="parsys parsys0 twc-col6_151515151515-c0 parsys_column">
      <div class="parbase section"><figure><img src="images/twc-tv-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c1 parsys_column  ">
      <div class="parbase section"><figure><img src="images/mlb-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c2 parsys_column  ">
      <div class="parbase section"><figure><img src="images/diy-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c3 parsys_column  ">
      <div class="parbase section"><figure><img src="images/msnbc-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c4 parsys_column  ">
      <div class="parbase section"><figure><img src="images/ifc-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c6 parsys_column  ">
      <div class="parbase section"><figure><img src="images/nick-icon.png"></figure></div>
      <div class="new section"></div>
    </div>
  </div>
...
<div class="15-15-15-15-15-15 section columnControl">
  <div class="parsys_column twc-col6_151515151515">
    <div class="parsys parsys0 twc-col6_151515151515-c0 parsys_column">
      <div class="parbase section"><figure><img src="images/bravo-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c1 parsys_column  ">
      <div class="parbase section"><figure><img src="images/starz-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c2 parsys_column  ">
      <div class="parbase section"><figure><img src="images/comedy-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c3 parsys_column  ">
      <div class="parbase section"><figure><img src="images/mtv-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c4 parsys_column  ">
      <div class="parbase section"><figure><img src="images/watch-espn-icon.png"></figure></div>
      <div class="new section"></div>
    </div>

    <div class="parsys parsys1 twc-col6_151515151515-c6 parsys_column  ">
      <div class="parbase section"><figure><img src="images/showtime-anytime-icon.png"></figure></div>
      <div class="new section"></div>
    </div>
  </div>
...
<hr class="spacer">
                                        ...
                                        <div class="parsys column parsys1">
                                            <div class="wifiContainer">
                                                <div class="mobileBG" style="margin-bottom:7em;">
                                                    ...
                                                    <hr class="spacer">
                                                    <div class="cta twc-icon-after icon-angle-right section omegaWhite fs-19 mobile-full">
    ...
    <div class="100 section columnControl">
  <div class="parsys_column twc-col1_100-c0">
    <div class="parsys parsys0 twc-col100_1-c0 parsys_column internal" style="background-image: url(images/hp-on-demand-background.png);">
            ...
            <div class="50-50 section columnControl">
              <div class="parsys_column twc-col2_5050">
                <div class="parsys parsys0 twc-col2_5050-c0 parsys_column internal ">
                  ...
                  <div class="clear"></div>
                    <figure style="margin: 5em 0;">
                        <img alt="All Devices" src="images/hp-on-demand-devices.png">
                    </figure>
                    <hr class="spacer">
                    <div class="clear"></div>
                  </div>
                ...
                <div class="parsys parsys1 twc-col2_5050-c1 parsys_column internal ">
                  <div class="parbase section">
                    <div class="ondemand" >
                        <p class="fs-26 light">Watch thousands of movies<br> and binge-worthy shows<br> On Demand</p>
                          <hr class="spacer">
                          <div class="cta twc-icon-after horizontal-center parbase smartLink icon-angle-right section non-indented fs-19">
                            <a href="#">
                              <span class="link-label">See What's Available</span>
                            </a>
                          </div>
                    </div>
                  </div>
                                ...
                                <div id="7b29c5a5-ba5d-4bd5-b1dd-7a606777dc89">
                                    <div class="flyout">
                                          <div class="flyoutIcon">
                                                <figure>
                                                    <a analyticsname="test" href="#">
                                                        <img alt="Improved Service" src="images/lockup-icon-all-packages.png">
                                                    </a>
                                                </figure>
                                            </div>
                                            <div class="cta omegaWhite twc-icon-after icon-angle-right h6">
                            ...
                            <div id="d62c3cb8-ccc8-4203-a818-6519f3439eb1">
                                <div class="flyout">
                                      <div class="flyoutIcon">
                                            <figure>
                                                <a analyticsname="test" href="#">
                                                    <img alt="Improved Service" src="images/lockup-icon-shoptag.png">
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="cta omegaWhite twc-icon-after icon-angle-right h6">
                            ...
                            <div>
                                 <div class="flyout">
                                      <div class="flyoutIcon">
                                            <figure>
                                                <a analyticsname="test" href="#">
                                                    <img alt="Improved Service" src="images/lockup-icon-twc-stores.png">
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="cta omegaWhite twc-icon-after icon-angle-right h6">
                            ...
                            <div>
                                <div class="flyout">
                                      <div class="flyoutIcon">
                                            <figure>
                                                <a analyticsname="test" href="#">
                                                    <img alt="Improved Service" src="images/lockup-icon-call-twc.png">
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="cta omegaWhite twc-icon-after icon-angle-right h6">
  ...
  <div class="scroll-arrow">
    <span>SCROLL
      <div class="twc-icon-only icon-chevron-down">
        <span></span>
      </div>
    </span>
  ...
  <div class="twc-container">
    <ul class="horizontal text-center">
      <li class="socialHeader tablet-hidden">
        <span class="h4 light text-white">Follow Us</span>
      </li>
      <li>
        <a href="">
          <img src="images/facebook.png" alt="Facebook">
          <span class="fs-15 light text-white tablet-hidden">Facebook</span>
        </a>
      </li>
      <li>
        <a href="">
          <img src="images/twitter.png" alt="Twitter">
          <span class="fs-15 light text-white tablet-hidden">Twitter</span>
        </a>
      </li>
      <li>
        <a href="">
          <img src="images/instagram.png" alt="Instagram">
          <span class="fs-15 light text-white tablet-hidden">Instagram</span>
        </a>
      </li>
      <li>
        <a href="">
          <img src="images/youtube.png" alt="Youtube">
          <span class="fs-15 light text-white tablet-hidden">YouTube</span>
        </a>
      </li>
      <li>
        <a href="">
          <img src="images/untangled.png" alt="Untangled Blog">
          <span class="fs-15 light text-white tablet-hidden">Untangled Blog</span>
        </a>
      </li>
      <li>
        <a href="">
          <img src="images/facebook.png" alt="Facebook">
          <span class="fs-15 light text-white tablet-hidden">Mi Cultura</span>
        </a>
      </li>
    </ul>
  </div>
