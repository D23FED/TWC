...
console.log('running');
    ...
    var arrLPvars = [
      ...
      { scope:'page', name:'unit', value:'ecommerce', mobile:true },   
    { scope:'page',name:'eCommerceSite',value:eCommerceSite_var, mobile:true},
      { scope:'page', name:'pageType', value:eCommerceSite_var, mobile:true }, //Potential Values: learn, abf, ebf
    { scope:'session', name:'language', value:'english', mobile:true },
      ...
      { scope:'page', name:'Section', value:_satellite.getVar('GTM-DataLayer')[0]['Page Name'], mobile:true },
    ...
    { scope:'page', name:'ConversionStage', value:_satellite.getVar('GTM-DataLayer')[0]['Page Name'], mobile:true }, //Name of current page in checkout flow: i.eretc.
    { scope:'page', name:'CartTotal', value:_satellite.getVar('GTM-DataLayer')[0]['transactionValue'], mobile:true }, //Value of cart contents

    { scope:'session', name:'UserType', value:_satellite.getVar('GTM-DataLayer')[0]['VisitorLoginState'], mobile:true }, //authenticated or unauthenticated 
    { scope:'session', name:'Bfvisitortype', value:vt, mobile:true }, //abfvisitor,ebfvisitor
    { scope:'session', name:'customerRegion', value:region_test, mobile:true }, //nyc,tx,los angeles, san diego, out of footprint
    //Confirmation Page variables
    { scope:'page', name:'OrderNumber', value:_satellite.getVar('GTM-DataLayer')[0]['OrderID'], mobile:true }, //Unique order number
    { scope:'page', name:'OrderTotal', value:_satellite.getVar('GTM-DataLayer')[0]['transactionValueMonthly'], mobile:true }, //Final value of order
    { scope:'page', name:'PSUTotal', value:_satellite.getVar('GTM-DataLayer')[0]['PSU'], mobile:true } //PSU Count for order just placed
    ];
...
if(_satellite.getVar('lpClone')=="true"){
 appid= _satellite.getVar('LP Clone Account');
  ...
  appid=_satellite.getVar('LP Prod Account');
    ...
    lpTag.dbs.push({ name:'chat-ecommerce-english', pid:'lpButtonDiv' });
    ...
    var sendVarsOnClick = function () {
      ...
      //Example variables for passing after page load - if there are variables you don't want sent in the mobile version, specify them using mobile:false
        { scope:'page', name:'PAGE_VARIABLE_NAME', value:'changed by onclick', mobile:true },
        { scope:'page', name:'ONCLICK_PAGE_VARIABLE_NAME', value:'VARIABLE_VALUE', mobile:true },
        { scope:'session', name:'ONCLICK_SESSION_VARIABLE_NAME', value:'VARIABLE_VALUE', mobile:true },
        { scope:'visitor', name:'ONCLICK_VISITOR_VARIABLE_NAME', value:'VARIABLE_VALUE', mobile:false }
      ];
