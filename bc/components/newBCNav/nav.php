...
<nav role="navigation" class="twc-new-navigation">
  <div class="twc-container">
    <ul class="twc-new-nav">
      <li class="nav-menu-1">
        <figure>
          <img src="/TWC/bc/core/images/nav-2.png" alt="What's On">
        </figure>
      ...
      <li class="nav-menu-2">
        <figure>
          <img src="/TWC/bc/core/images/nav-1.png" alt="Plans">
        </figure>
      ...
      <li class="nav-menu-3">
        <figure>
          <img src="/TWC/bc/core/images/nav-3.png" alt="Account">
        </figure>
      ...
      <li class="nav-menu-4">
        <figure>
          <img src="/TWC/bc/core/images/nav-4.png" alt="Support">
        </figure>
      ...
      <li class="desktop-hidden nav-menu-5">
        <figure>
          <img src="/TWC/bc/core/images/nav-5.png" alt="more">
        </figure>
