<h3>Body Text</h3>
<hr class="solid">
<h6>.lede (Feature Intro) - Arial 17px / 24px #333</h6>
...
<div class="50-50 section columnControl">
  <div class="parsys_column twc-col2_5050">
    ...
    <div class="parsys parsys1 twc-col2_5050-c1 parsys_column">
      <div class="parbase section">
        <h6>.body-text - Arial 13px / 18px #333</h6>
...
<div class="50-50 section columnControl">
  <div class="parsys_column twc-col2_5050">
    <div class="parsys parsys0 twc-col2_5050-c0 parsys_column">
      <div class="parbase section">
        <h6>.slider-text (Slider Module) - Arial 13px / 15px #333</h6>

        <p class="slider-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
        <hr class="spacer desktop-hidden">
      </div>
      <div class="new section"></div>
    </div>
    <div class="parsys parsys1 twc-col2_5050-c1 parsys_column">
      <div class="parbase section">
        <h6>.small-body-text - Arial 12px / 15px #333</h6>
...
<div class="50-50 section columnControl">
  <div class="parsys_column twc-col2_5050">
    <div class="parsys parsys0 twc-col2_5050-c0 parsys_column">
      <div class="parbase section">
        <h6>.disclaimer-text - Arial 11px / 13px #333</h6>
        ...
        <hr class="spacer desktop-hidden">
        <h6>.body-disclaimer - Arial 9px #69696C</h6>
        <p class="body-disclaimer">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse iste, facere nam deserunt accusantium, reiciendis recusandae molestiae amet similique error blanditiis dolorum voluptatum nisi nemo modi ipsa, non dicta ut!</p>
        <hr class="spacer desktop-hidden">
      </div>
      <div class="new section"></div>
    </div>
    <div class="parsys parsys1 twc-col2_5050-c1 parsys_column">
      <div class="parbase section">
        <h6>Link Text - Arial Bold #3376B2 </h6>

        <p>Line text appear in a paragraph will be the same font size and line spacing as the
        other text (unless otherwise specified).<br><br>
        Lorem ipsum dolor sit amet, consectetuer adipiscing elit. <a href="#">Phasellus</a> hendrerit.
        Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapibus id, mattis vel,
        nisi. Sed pretium, ligula sollicitudin laoreet viverra, <a href="#">tortor libero</a> sodales leo, eget
