...
?>
    ...
    <div class="tab-component">
      ...
      <div class="tabs">
        <ul>
          <li class="js-active twc-icon-before icon-globe"><a class="h5" href="#" data-ref="#tab1"><span>Internet</span></a></li>
          <li><a class="h5" href="#" data-ref="#tab2">TV</a></li>
          <li><a class="h5" href="#" data-ref="#tab3">Phone</a></li>
          <li><a class="h5" href="#" data-ref="#tab4">IntelligentHome</a></li>
          <li><a class="h5" href="#" data-ref="#tab5">My Account</a></li>
          <li><a class="h5" href="#" data-ref="#tab6">Support</a></li>
        </ul>
      </div>
...
<hr>
    ...
    <div class="tab-component">
      ...
      <div class="tabs">
        <ul>
          <li class="js-active twc-icon-before icon-globe">
            <a class="h5" href="#" data-ref="#tab1">
              <span>Internet</span>
            </a>
          </li>
          <li>
            <a class="h5" href="#" data-ref="#tab2">
              <span>TV</span>
            </a>
          </li>
        </ul>
