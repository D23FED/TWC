...
<?php include($_SERVER['DOCUMENT_ROOT']. '/TWC/core/includes/panel.php'); ?>
      ...
      <div class="parsys parsys1 twc-col2_2476-c1 parsys_column">
        <div class="parbase section">
          <div class="twc-topicLOBs">
            <div class="info-box">
              <span class="h5">
                Sync your devices with your remote control.
              </span>
              <p>
                Select the device and brand you would like to sync to recieve detailed programming instructions.
              </p>
