...
<div class="packageSelectTabs">
  ...
  <div class="packageSelect stickyElement">
      ...
      <div class="packageBody">
        ...
        <div class="specialOffer">
          <div class="steelDark-9">
            <div class="text-center">
              <div class="h4 block">Bundle &amp; save from:</div>
              <div class="h2">
    ...
    <div class="package triple">
      <div class="packageHead">
        <div class="packageTitle">
          <p class="h5">Triple Play Silver</p>
        </div>
      ...
      <div class="packageBody">
              ...
              <div class="parsys parsys0 twc-col3_333333-c0 parsys_column">
                <div class="parbase section bordered-right">
                  <div class="text-center">
                    ...
                    <p class="b">TV</p>
                    <a href="" class="fs-14">175+ <br>Channels</a>
                  </div>
                </div>
                <div class="new section"></div>
              </div>
        ...
        <div class="specialOffer">
          <div class="steelDark-9">
            <div class="text-center">
              <div class="h4 block">Bundle &amp; save: Select +</div>
              <div class="h2">
    ...
    <div class="package triple">
      ...
      <div class="packageBody">
        ...
        <div class="specialOffer">
          <div class="steelDark-9">
            <div class="text-center">
              <div class="h4 block">Bundle &amp; save: SILVER +</div>
              <div class="h2">
                <div class="left fs48">$20</div>
                <div class="right">
                  <p class="h4">more</p>
