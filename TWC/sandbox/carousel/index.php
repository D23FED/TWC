    ...
    <div class="heroIcons">
      <div class="iconWrapper">
       <div id="heroCarouselIcon-1" class="carouselIcons active">
          <figure>
             <img src="images/hd-icon-grey.png" alt="">
            <img src="images/hd-icon-blue.png" alt="">
          </figure>
          <h6 class="book">
            HD Channels
          </h6>
        ...
        <div id="heroCarouselIcon-2" class="carouselIcons">
          <figure>
            <img src="images/on-demand-icon-grey.png" alt="">
            <img src="images/on-demand-icon-blue.png" alt="">
          </figure>
          <h6 class="book">
            On Demand
          </h6>
        ...
        <div id="heroCarouselIcon-3" class="carouselIcons">
            <figure>
            <img src="images/whole-house-icon-grey.png" alt="">
            <img src="images/whole-house-icon-blue.png" alt="">
          </figure>
          <h6 class="book">
            DVR
          </h6>
        ...
        <div id="heroCarouselIcon-4" class="carouselIcons">
            <figure>
           <img src="images/twc-app-icon-grey.png" alt="">
            <img src="images/twc-app-icon-blue.png" alt="">
          </figure>
          <h6 class="book">
            TWC TV<sup>®</sup> App
          </h6>
        ...
        <div id="heroCarouselIcon-5" class="carouselIcons">
          <figure>
            <img src="images/tv-everywhere-icon-grey.png" alt="">
            <img src="images/tv-everywhere-icon-blue.png" alt="">
          </figure>
          <h6 class="book">
            TV Everywhere
          </h6>
        ...
        <div id="heroCarouselIcon-6" class="carouselIcons">
             <figure>
             <img src="images/premium-icon-grey.png" alt="">
            <img src="images/premium-icon-blue.png" alt="">
          </figure>
          <h6 class="book">
            Premium Networks
          </h6>
        ...
        <div id="heroCarouselIcon-7" class="carouselIcons">
            <figure>
            <img src="images/sport-pack-icon-grey.png" alt="">
            <img src="images/sport-pack-icon-blue.png" alt="">
          </figure>
          <h6 class="book">
            Sports Packages
          </h6>
