...
<section class="installation-options">
	...
	<form action="" id="form-install">
	<!-- Select install option -->
	<div class="select-install-type">
		<fieldset>
		<label for="appointment">
			<input type="radio" id="input-appointment">
			<span class="option-description"><span>Schedule an appointment for a technician to install my services. Additional charges may apply.</span><span>Any applicable service charges will be itemized under One-Time Charges below.</span></span>
		</label>
		</fieldset>
		<div class="price">
...
<section class="review-services">
	...
	<div class="services-section monthly-charges">
		...
		<div class="tv">
			<header>
				<h4>TV</h4>
				<p><a href="#" class="modify-features">Add/Edit boxes or channels</a></p>
			</header>
			<table>
				<tr>
		...
		<div class="internet">
			<header>
				<h4>TV</h4>
				<p><a href="#" class="modify-features">Add/Edit speed or equipment</a></p>
			</header>
			<table>
				<tr>
		...
		<div class="phone">
			<header>
				<h4>TV</h4>
				<p><a href="#" class="modify-features">Add/Edit features</a></p>
			</header>
			<table>
				<tr>
