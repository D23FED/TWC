                  ...
                  <div class="parbase section">
                    <div class="heroContainer">
                        <h1 class="super-h1">TWC. It's on!</h1>
                          <p class="fs-23 light">More HD channels, faster internet,<br> unlimited phone. 24/7 home security<br> and 1-hour service windows.</p>
                          <hr class="spacer">
                          <div class="cta twc-icon-after horizontal-center parbase smartLink icon-angle-right section non-indented fs-17">
                            <a href="#">
                              <span class="link-label book">Discover TWC</span>
                            </a>
                          </div>
                    </div>
                  </div>
        ...
        <div class="parsys parsys1 twc-col4_25252525-c3 parsys_column">
          <div class="parbase section text-center">
            ...
            <div class="offerStripContainer">
              ...
              <hr class="spacer">
              <div class="pricing">
            <figure><img src="http://www.timewarnercable.com/content/dam/residential/specials-ola/images/061815_ny_reward_card/rewards-card.png" style="
    max-height: 35px;"></figure>
          </div>
              <div class="cta flatOmega icon-after icon-angle-right">
                <a href="#">
          ...
          <div class="parsys parsys0 twc-col5_2020202020-c0 parsys_column">
            <div class="parbase section">
              ...
              <div class="flyout">
                  ...
                  <div class="flyoutContent-down flyoutContent-left alternative">
          ...
          <div class="parsys parsys1 twc-col5_2020202020-c1 parsys_column">
            <div class="parbase section">
              ...
              <div class="flyout">
                  ...
                  <div class="flyoutContent-down flyoutContent-right alternative">
                      <div class="vertical lined">
                          <ul>
                              <li class="js-first">
                                  <a href="">
