...
<div class="twc-content">
  ...
  <div class="image imageArtDirection image-focus-1 parbase section">
    <div class="image-focus-1 " style="background-color: #f6f6f6; height: auto;">
      <div class="parsys art-direction-par">
        <div class="twc-container">
          <div class="w60 left">
            <figure>
          ...
          <div class="w40 left">
            <div class="heroContentWrapper">
              <h1>TWC. It's on!</h1>
              <p class="h6">More HD channels, faster internet, unlimited phone. 24/7 home security and 1-hour service windows.</p>
              <hr class="spacer">
              <div class="twc-icon-after horizontal-center parbase smartLink icon-angle-right section non-indented">
                <a href="#">
  ...
  <div class="segmentedBorder">
    <div class="segmentedBorderHeading text-center">
      <span class="h1">You might like</span>
    </div>
  ...
  <div class="flyoutContainer">
    <div class="twc-container">
      <div class="text-center">
        <span class="h1">The new Time Warner Cable</span>
        <div class="clear"></div>
        <hr class="spacer">
      </div>
      <div class="20-20-20-20-20 section columnControl">
          ...
          <div class="parsys parsys0 twc-col5_2020202020-c0 parsys_column">
            <div class="parbase section">              
              ...
              <div class="flyout">
                  ...
                  <div class="cta white twc-icon-after icon-angle-down flyoutCTA" id="flyoutCTA0">
                    
                    <a analyticsname="test" href="#">                            
                        <span>Discover Internet</span>
                    </a>
                  </div>

                  <div class="flyoutContent-down flyoutContent-left">                      
                      <div class="vertical lined">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span>Learn About Internet</span>
                                  </a>
                              </li>
                              <li>
                                  <a href="">
                              ...
                              <li>
                                  <a href="">
                                      <span>Lease or Buy a Modem</span>
                                  </a>
                              </li>
            ...
            <div class="parbase section">             
              ...
              <div class="flyout">
                  <div class="flyoutIcon">                        
                    ...
                    <div class="cta white twc-icon-after icon-angle-down flyoutCTA" id="flyoutCTA1">
                        
                        <a analyticsname="test" href="#">
                            <span>Discover TV</span>
                        </a>
                  </div>

                  <div class="flyoutContent-down flyoutContent-right">                     
                      <div class="vertical lined">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span>Learn About TV</span>
                                  </a>
                              </li>
                              ...
                              <li>
                               ...
                               <li>
                                  <a href="">
                                      <span>Sports Packages</span>
                                  </a>
                              </li>
                               <li>
                                  <a href="">
                                      <span>Download TV Apps</span>
                                  </a>
                              </li>
                               <li>
                                  <a href="">
            ...
            <div class="parbase section">             
              ...
              <div class="flyout">
                  <div class="flyoutIcon">                        
                    ...
                    <div class="cta white twc-icon-after icon-angle-down flyoutCTA" id="flyoutCTA2">
                        
                      <a analyticsname="test" href="#">
                          <span>Improved Service</span>
                      </a>
                  </div>
                  ...
                  <div class="flyoutContent-down flyoutContent-left">                      
                      <div class="vertical lined">
                          <ul>
                              ...
                              <li>
                                  <a href="">
                                      <span>Reset TWC ID Password</span>
                                  </a>
                              </li>
                              ...
                              <li class="js-last">
                                  <a href="">
                                      <span>Add or Upgrade Services</span>
                                  </a>
                              </li>
                          </ul>
                      </div>
            ...
            <div class="parbase section">             
              ...
              <div class="flyout">
                  <div class="flyoutIcon">                        
                    ...
                    <div class="cta white twc-icon-after icon-angle-down flyoutCTA" id="flyoutCTA3">
                        
                      <a analyticsname="test" href="#">
                          <span>Discover Phone</span>
                      </a>
                  </div>
                  ...
                  <div class="flyoutContent-down flyoutContent-right">                     
                      <div class="vertical lined">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span>Learn About Phone</span>
                                  </a>
                              </li>

                              <li>
                                  <a href="">
                                      <span>Popular Calling Features</span>
                                  </a>
                              </li>
                              ...
                              <li>
                                  <a href="">
                                      <span>Download the Phone 2 Go App</span>
                                  </a>
                              </li>
                              <li>
                                  <a href="">
            ...
            <div class="parbase section">             
              ...
              <div class="flyout">
                <div class="flyoutIcon">                        
                  ...
                  <div class="cta white twc-icon-after icon-angle-down flyoutCTA" id="flyoutCTA4">
                  ...
                  <div class="flyoutContent-down flyoutContent-last alternative">
                      <div class="vertical lined">
                          <ul>
                              <li class="js-first">
                                  <a href="">
                                      <span>Learn About Home Security</span>
                                  </a>
                              </li>
  ...
  <!-- begin image art blocks -->
                    ...
                    <div class="parsys column parsys1">
                        <div class="richtext section">
                            ...
                            <div class="block text-center">
                                ...
                                <hr class="spacer">
                                <div class="twc-icon-after cta icon-angle-right section omegaWhite fs-18">
                                <a href="/en/apps.html?iid=tv-lob:3:1:tvapps" analyticsname="tv-lob:4:2:learn about our tv apps">
                                    <span>See Apps Invetory</span>
                                </a>
                                <div class="clear"></div>
                                </div>
                            </div>
    ...
    <!-- start image art 2 -->
    <div class="image imageArtDirection image-focus-1 parbase section">
    <div style="background-image: url(images/twc-hp-wifi-background.jpg); height: auto;" class="image-focus-1">
        <div class="parsys twc-container art-direction-par"><div class="columnControl parsys 50-50 section">
                            ...
                            <div class="columnControl parsys 33-67 section">
                                <div class="parsys_column twc-col2_3367">
                                    <div class="twc-col2_3367-c0  parsys_column" id="">
                                        <div class="parsys parsys0 column">
                                            <div class="richtext section">
                                                <figure><img style="margin-top:9em;" src="images/twc-hp-wifi-icon.jpg"></figure>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="twc-col2_3367-c1  parsys_column" id="">
                                        <div class="parsys column parsys1">
                                            ...
                                            <p style="margin-top:3em;" class="h1 mobile-full block"> Free access to hotspots nationwide</p>
                                            <hr class="spacer">
                                            <div style="margin-bottom:3em;" class="twc-icon-after cta icon-angle-right section omegaWhite fs-18 mobile-full">
    ...
    <!-- end image art 2 -->
    <!-- start image art 3 -->
    <div class="image imageArtDirection image-focus-5 parbase section">
    <div style="background-image: url(images/twc-hp-ondemand-background.jpg); height: auto;" class="image-focus-5">
        <div class="parsys twc-container art-direction-par"><div class="columnControl parsys 50-50 section">
            <div class="parsys_column twc-col2_5550   ">
                <div class="twc-col2_5050-c0  parsys_column" id="">
                    <div class="parsys parsys0 column">
                ...
                <div class="twc-col2_5050-c1  parsys_column" id="">
                    <div class="parsys column parsys1">
                        <div class="richtext section">
                            ...
                            <hr class="spacer">
                            <div style="margin-bottom:2em;" class="twc-icon-after cta icon-angle-right section omegaWhite fs-18 mobile-full">
                            <a href="#" analyticsname="#">
                        ...
                        <div class="parsys parsys0 column">
                            <div class="richtext section">
                                <div id="7b29c5a5-ba5d-4bd5-b1dd-7a606777dc89">
                                    <div class="text-center">
                                        <div class="twc-icon-after horizontal-center parbase icon-angle-right section non-indented omegaWhite fs-18">
                                            <a href="#" analyticsname="#">
