        ...
        <li>
          <div class="clickIcon offPage">
            <a href="">
              ...
              <span class="mobile-hidden">Shop Deals</span>
                  ...
                  <div class="parsys parsys0 twc-col2_5050-c0 parsys_column">
                    <div class="parbase section">
                      <div class="labelList section">
                        <h4 class="label">DISCOVER PRODUCTS</h4>
                        <ul>
                          <li>
                                        ...
                                        <div class="parsys column parsys1">
                                            <div class="wifiContainer">
                                                <div class="mobileBG" style="margin-bottom:7em;">
                                                    ...
                                                    <hr class="spacer">
                                                    <div class="twc-icon-after cta icon-angle-right section omegaWhite fs-19 mobile-full">
