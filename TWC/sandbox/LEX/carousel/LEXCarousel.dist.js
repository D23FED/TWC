...
$( document ).ready( function() {
	...
	var slides = [ {
			'desktop': {
				'image': '/content/dam/residential/images/homepage-responsive/hero/hp-lex-bg-itsOn-071715.jpg',
				'icon': false,
				'focus': '50% center'
			},
			'mobile': {
			...
			'desktop': {
				'image': '/content/dam/residential/images/homepage-responsive/hero/hp-lex-bg-one-hour-service-073015.jpg',
				'icon': false,
				'focus': '50% center'
			},
			'mobile': {
