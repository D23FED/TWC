...
$( window ).resize( function() {
	...
	function( a ) {
		a.fn.componentName = function() {}
	}( jQuery ), $( ".componentName" ).componentName(), $( ".accordion .expandable ul li" ).each( function() {
...
$( window ).width() >= mediumBreakPoint && adjustTopicHeight(), $( window ).bind( "resize", function() {
	...
	function( a ) {
		...
		$( ".formValidate form" ).parsley(), $( '.formValidate input[name="zip2"]' ).autotab();
		var c = 0;
		a()
