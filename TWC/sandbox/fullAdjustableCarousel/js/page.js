...
var verticalCarousel = {
    create: function (wrapper, slides, options) {
        ...
        $(window).resize(function () {
            try {
                ...
                BrowserType = verticalCarousel.widthPage();
                verticalCarousel.heroHeight();
                verticalCarousel.contentHeight();
    ...
    */
    ...
    /*
    * calculate hero height based on image art component height
    */
    contentHeight: function() {
        var maxHeight = 0,
            controls = $('.hero-slider-progress').outerHeight(true),
            hero_height = 0;
        $('.huge-hero-image .imageArtDirection > div').height('auto');
        $('.huge-hero-image').not('.clone').find('.imageArtDirection').children().each(function (){
        ...
        $(".huge-hero, .huge-hero-image, .huge-hero .overlay, .huge-hero-image .imageArtDirection > div ").height(hero_height);
...
$(document).ready(function() {
    ...
    */
    ...
    { 
        'desktop': {
             'image': 'images/hp-lex-bg-itsOn-071715.jpg',              
            'icon': false,
            'focus': '50% center'
        },       
        'mobile': {
    ...
    {
        'desktop': {
             'image': 'images/hp-lex-bg-one-hour-service-073015.jpg',              
            'icon': false,
            'focus': '50% center'
        },       
        'mobile': {
