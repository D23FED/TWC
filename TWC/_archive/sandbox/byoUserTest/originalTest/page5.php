...
<div class="packageSelectTabs">
  <div class="psTabs">
    ...
    <div class="tab-content">
      ...
      <div class="super-h3 light block text-center">
      You have selected TV & Internet.</div><br>
      <div class="super-h3 block text-center"><b>Select your Internet plan - you can 'Compare' up to 3 plans:</b></div><br>
          ...
          <div class="package single">
            ...
            <div class="packageBody">
              <div class="packageInfo">
                ...
                <p class="text-center">
                  Free <a class="tooltip below" href="#">Home WiFi<span class="tooltip-text">Includes Home WiFi - pay for Wireless Gateway only ($8/mo).  Set up a wireless home network and connect multiple WiFi-enabled devices to the Internet over one superfast wireless connection.</span></a>
                </p>
              </div>
              <div class="pricing temp text-center">
                <span class="h4">
