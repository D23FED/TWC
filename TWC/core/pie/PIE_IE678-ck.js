(function(O, H) {
	...
	h.Mc = h.v.sa({
		...
		vc: function() {
			var a = this.bc();
			if (a && (this.o.oc() || this.g.jb.L())) a.styleparsys section twc - box - columnText = this.ac()
		},
		ec: function() {
			var a = this.d;
