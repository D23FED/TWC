...
<div class="step-nav horizontal text-center">
            <ul>
                ...
                <li class="active"><a href="page5.php">3. Internet</a></li>
                <li class="active"><a href="page6b.php">4. Equipment</a></li>
                <li class="active"><a href="#">5. Review</a></li>
            </ul>
            <div class="text-right">
                Service Selections:<br><b> TV & Internet.</b>
            </div>
        </div>
      <div class="super-h3 light block" style="width:100%; text-align:center;">
      <b>Step 5:</b> Review Your Selections</div><br><br>
      <center>
      <div style="max-width:70%;">
     <div style="width: 29%; text-align:left; display: inline-block; padding: 0 1em;"><p class="fs-18">TV + Equipment</p></div>
      <div style="width: 69%; text-align:right; display: inline-block; padding: 0 1em;"><p class="fs-18"><b>$61.24</b> per month for 12 mos.</p></div>
      <div style="width: 29%; text-align:left; display: inline-block; padding: 0 1em;"><p class="fs-18">Internet + Equipment</p></div>
      <div style="width: 69%; text-align:right; display: inline-block; padding: 0 1em;"><p class="fs-18"><b>$44.99</b> per month for 12 mos.</p></div>
      <div style="width: 29%; text-align:left; display: inline-block; padding: 0 1em;"><p class="fs-18">Phone</p></div>
      <div style="width: 69%; text-align:right; display: inline-block; padding: 0 1em;"><p class="fs-18"><b>$10.00</b> per month for 12 mos.</p></div>
      <hr>
      <div style="width: 100%; text-align:right; display: inline-block; padding: 0 1em;"><p class="fs-18"><b>Total $116.23</b> per month for 12 mos.</p></div>
      </div>
      <div style="width: 100%; text-align:center; display: inline-block; margin-top: 2em;">
        <div class="cta icon-after fs-30 icon-angle-right">
            <a href="https://www.timewarnercable.com/residential/order?qso=TESTTVEXTREME2">
              <span>Order Now</span>
            </a>
        </div>
      </div>
          ...
          <div class="package single">
            <div class="packageHead">
              ...
              <div class="packageTitle">
                <div class="selectedBox"><div class="icon-only icon-ok"><span></span></div></div>
                <div class="right">
                  <span>TV</span>
                </div>
              </div>
            ...
            <div class="quickCheckoutWrapper">
                  ...
                  <p class="text-link fs-20"><b>Your Equipment</b></p>
                  <div class="box">
                    ...
                    <div class="productSelect">
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <input id="pack1-tv-equipment-1" name="pack1-tv-equipment" type="radio" checked disabled="disabled">
                            </td>
                            <td>
    ...
    <span class="tooltip-text">Watch programming in high definition and digital programming with amazing picture quality and digital sound.</span>
                          ...
                          <tr>
                            <td>
                              <input id="pack1-tv-equipment-2" name="pack1-tv-equipment" type="radio" disabled="disabled">
                            </td>
                            <td>
    ...
    <span class="tooltip-text">Record and watch HD and digital programming. Pause live TV, record 2 shows at once and record 30+ hours of programming. </span>
                          ...
                          <tr>
                            <td>
                              <input id="pack1-tv-equipment-4" name="pack1-tv-equipment" type="radio" disabled="disabled">
                            </td>
                            <td>
            ...
            <div class="packageFooter side-by-side">
              ...
              <div class="detailsExpansion">
                ...
                <div class="detailsContent text-left">
                ...
                <div class="change-remove">
                    <div class="cta icon-after" style="margin: 0 1.5em;">
                        <a href="page2.php">
                          <span>Change</span>
                        </a>
                      </div>
                    ...
                    <div class="productSelect">
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <input id="pack1-internet-equipment-1" name="pack1-internet-equipment" type="radio" disabled="disabled" checked>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <input id="pack1-internet-equipment-2" name="pack1-internet-equipment" type="radio" disabled="disabled">
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <input id="pack1-internet-equipment-4" name="pack1-internet-equipment" type="radio" disabled="disabled">
                            </td>
                            <td>
                ...
                <div class="detailsContent text-left">
                  <div class="vertical bulleted">
                    <ul>
                      <li class="listHead">Includes:</li>
                      <li>
                        <a href="" class="tooltip above">Unlimited Calling <span class="tooltip-text">Unlimited calls to the U.S., Canada, Mexico, China, Hong Kong, India, The EU, Norway and U.S. territories.</span></a>
                      </li>
                      <li>
                       <a href="" class="tooltip above">12+ calling features <span class="tooltip-text">Features include: Anonymous Call Rejection, Answer Anywhere, Call Forwarding, Call History, Call Waiting, Call Waiting Caller ID, Caller ID, Caller ID on TV, Charges Block, Enhanced 9-1-1, Outbound Caller ID Blocking, Phone 2 Go app, Speed Dial, VoiceZone, 3-Way Calling and 6-1-1 TWC Help. Private Listing and Voicemail are also available, each for an additional fee.</span></a>
                      </li>
                      <li>
                       <a href="" class="tooltip above">Phone 2 Go app <span class="tooltip-text">Connect with WiFi to make calls to anywhere in the U.S. and to popular international destinations, on up to five devices.</span></a>
                      </li>
                    </ul>
                  </div>
                </div>
