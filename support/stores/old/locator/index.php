...
<p class="subHead h6">
  Enter the ZIP Code or location of your service address below.
</p>
<!-- TEST SECTION -->
...
<div class="locate-stores">
  <form action="searchPage">
    <div class="form-inputs">
      <p class="light">
        Not your service address ZIP Code? Enter it now.
      </p>
        ...
        <div class="parsys_column twc-col3_252550">
          <div class="parsys parsys0 twc-col3_252550-c0 parsys_column">
            <div class="parbase section">
              ...
              <small>
                Enter ZIP Code, or Street Address, City, State
              </small>
            </div>
    ...
    <div class="expandable">
      <div class="refineList">
        <a href="#">
          <span class="cta twc-left twc-icon-after icon-angle-down">
            Refine Your Store List
          </span>
        </a>
      </div>
                    ...
                    <div class="100 section columnControl">
                      <div class="parsys_column twc-col1_100-c0">
                        <div class="parsys parsys0 twc-col100_1-c0 parsys_column">
                          <div class="parbase section">
                            <span class="light">
                              Uncheck items to remove from list
                            </span>
                          </div>
                                  ...
                                  <div class="parbase section">
                                    <div class="vertical">
                                      <ul>
                                        ...
                                        <li>
                                          <input id="icon-exchange" type="checkbox" checked name="">
                                          <label>
                                            Exchange Equipment
                                          </label>
                                        </li>
    ...
    <div class="parsys_column twc-col2_3367-c0 stores_location_details tab-content" id="stores_map_details">
      <div class="stores_locations_details_legend">
              ...
              <div class="parsys parsys1 twc-col2_5050-c1 parsys_column">
                <div class="parbase section">
                  <ul>
                    ...
                    <li>
                      <span class="icon-flag red-icon"></span>
                      New Store
                    </li>
                  </ul>
                </div>
        ...
        <div class="legend_note">
          <p> <b>NOTE:</b>
            Not all stores will exchange equipment; please check the details of each location.
          </p>
        </div>
      </div>
              ...
              <div class="parsys_column twc-col2_5050">
                ...
                <div class="parsys parsys1 twc-col2_5050-c1 parsys_column">
                  <div class="parbase section">
                    ...
                    <div class="bulleted">
                      <ul>
                        <li class="service_selfinstall">
                          Self Install
                        </li>

                        <li class="service_alldaypayment">
                          24-Hour Payment
                        </li>

                        <li class="service_democenter">
                          Demo Center
                        </li>

                        <li class="service_newequipment">
                          New Equipment
                        </li>

                        <li class="service_boxswap">
                          Box Swap
                        </li>

                        <li class="service_setup">
                          Setup
                        </li>
