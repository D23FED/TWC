      ...
      <div id="tab2" class="tab js-active">
        <div class="step-nav horizontal text-center">
                <ul>
                    ...
                    <li class="active"><a href="#">4. Equipment</a></li>
                    <li>5. Review</li>
                </ul>
        ...
        <div class="super-h3 block text-center"><b>Step 4: </b>Choose Equipment</div><br>
        <div class="packageSelect stickyElement">
          ...
          <div class="package single">
            ...
            <div class="quickCheckoutWrapper">
                  ...
                  <p class="text-link fs-20"><b>Choose Your Equipment</b></p>
                  <div class="box">
                            ...
                            <td>
                              <label for="pack1-tv-equipment-1">
                                <a href="" class="tooltip above">HD Box
                                  ...
                                  <span class="tooltip-text">Watch programming in high definition and digital programming with amazing picture quality and digital sound.
</span>
                                </a>
                              </label>
                            </td>
                            ...
                            <td>
                              <label for="pack1-tv-equipment-2">
                                <a href="" class="tooltip above">HD-DVR Box and Service
                                  ...
                                  <span class="tooltip-text">Record and watch HD and digital programming. Pause live TV, record 2 shows at once and record 30+ hours of programming.
</span>
                                </a>
                              </label>
                            </td>
