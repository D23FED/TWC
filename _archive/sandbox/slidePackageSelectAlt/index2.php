          ...
          <div class="package single">
                ...
                <div class="quickCheckoutAccordion">
                  ...
                  <div class="quickCheckoutContent box">
                    ...
                    <div class="text-center">
                      ...
                      <hr class="spacer">
                      <p class="b">You will have an opportunity to review your selections before placing your order.</p>
            ...
            <div class="packageFooter side-by-side">
              <div class="buttonWrapper">
                <div class="cta flatOmega expandDetails icon-after icon-angle-down">
                  <a href="">
                    ...
                    <div class="productSelect">
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <input id="pack2-tv-equipment-1" name="pack2-tv-equipment" type="radio" checked>
                            </td>
                            <td>
                              <label for="pack2-tv-equipment-1">
                                <a href="" class="tooltip above">HD Box
                                  <span class="tooltip-text">Watch programming in high definition and digital programming with amazing picture quality and digital sound.</span>
                                </a>
                              </label>
                          ...
                          <tr>
                            <td>
                              <input id="pack2-tv-equipment-2" name="pack2-tv-equipment" type="radio">
                            </td>
                            <td>
                              <label for="pack2-tv-equipment-2">
                                <a href="" class="tooltip above">HD-DVR Box and Service
                                  <span class="tooltip-text">Record and watch HD and digital programming. Pause live TV, record 2 shows at once and record 30+ hours of programming.</span>
                                </a>
                              </label>
                          ...
                          <tr>
                            <td>
                              <input id="pack2-tv-equipment-4" name="pack2-tv-equipment" type="radio">
                            </td>
                            <td>
                              <label for="pack2-tv-equipment-4">
                                <a href="" class="tooltip above">CableCARD
                                  <span class="tooltip-text">CableCARDs are only compatible with CableCARD-equipped televisions or other Unidirectional Digital Cable Products (UDCPs), like TiVos or cable-ready digital TVs.  If you do not own a UDCP, CableCARDs cannot be used with your equipment.</span>
                                </a>
                              </label>
                    ...
                    <div class="productSelect">
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <input id="pack2-internet-equipment-1" name="pack2-internet-equipment" type="radio">
                            </td>
                            <td>
                              <label for="pack2-internet-equipment-1">
                                <a href="" class="tooltip above">Internet Modem
                                  <span class="tooltip-text">Includes Home WiFi - pay for Wireless Gateway only ($8/mo).  Set up a wireless home network and connect multiple WiFi-enabled devices to the Internet over one superfast wireless connection. </span>
                                </a>
                              </label>
                          ...
                          <tr>
                            <td>
                              <input id="pack2-internet-equipment-2" name="pack2-internet-equipment" type="radio" checked>
                            </td>
                            <td>
                              <label for="pack2-internet-equipment-2">
                          ...
                          <tr>
                            <td>
                              <input id="pack2-internet-equipment-4" name="pack2-internet-equipment" type="radio">
                            </td>
                            <td>
                              <label for="pack2-internet-equipment-4">
                                <b>I'll use my own modem</b>
                              </label>
                            </td>
                            <td class="price">
                    ...
                    <div class="priceTally">
                      <table>
                        ...
                        <tr>
                          <td class="b">Charges reflected in your cart</td>
                          <td class="b">Total</td>
                          <td class="b price total">$68.24</td>
                        </tr>
                      </table>
                    </div>
                    <div class="text-center">
                      ...
                      <div class="cta green icon-after icon-angle-right">
                        <a href="https://www.timewarnercable.com/residential/order?qso=TESTDP4999">
                          <span>Checkout</span>
                        </a>
                      </div>
                    </div>
                ...
                <div class="detailsContent">
                  <div class="vertical bulleted">
                    <ul>
                      <li class="listHead">Includes:</li>
                      <li>
                        <a href="" class="tooltip above">HBO&reg; <span class="tooltip-text">Enjoy hundreds of top movies and original series on your tablet, smartphone or laptop. Includes access to HBO GO®.</span></a> and <a href="" class="tooltip above">SHOWTIME&reg; <span class="tooltip-text">Get unlimited On Demand access to Showtime original series, movies, sports and more. Includes access to the SHOWTIME ANYTIME® app.</span></a>
                      </li>
                      <li>
                       <a href="" class="tooltip above">TWC TV&copy; <span class="tooltip-text">Watch live TV on your tablet, computer or smartphone from any room in your home.</span></a>
                      </li>
                       <li>
                        <a href="" class="tooltip above">Home WiFi <span class="tooltip-text">Includes Home WiFi - pay for Wireless Gateway only ($8/mo).  Set up a wireless home network and connect multiple WiFi-enabled devices to the Internet over one superfast wireless connection.  </span></a>
                      </li>
                      <li>
                         <a href="" class="tooltip above">TWC WiFi&copy; Hotspots <span class="tooltip-text">Get fast and reliable wireless Internet access when you’re on-the-go at any TWC WiFi Hotspot.</span></a>
                      </li>
          ...
          <div class="package single">
            ...
            <div class="packageBody">
              <div class="packageInfo">
                ...
                <p class="text-center">
                  Speeds up to <a class="tooltip below" href="#">30/5Mbps<span class="tooltip-text">Best for connecting 3-5 devices at the same time. Great for surfing, email, online shopping and social networking.</span></a>
                </p>
              </div>
              <div class="pricing temp text-center">
                <span class="h4">
              ...
              <hr>
              <div class="specialOffer text-center">
              <h5>Includes EPIX&reg; and set-top box</h5>
              </div>
              <hr>
              <div class="quickCheckoutWrapper">
                <div class="quickCheckoutAccordion">
                    ...
                    <div class="productSelect">
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <input id="pack3-tv-equipment-1" name="pack3-tv-equipment" type="radio" checked>
                            </td>
                            <td>
                              <label for="pack3-tv-equipment-1">
                                <a href="" class="tooltip above">HD Box
                                  <span class="tooltip-text">Watch programming in high definition and digital programming with amazing picture quality and digital sound.</span>
                                </a>
                              </label>
                          ...
                          <tr>
                            <td>
                              <input id="pack3-tv-equipment-3" name="pack3-tv-equipment" type="radio">
                            </td>
                            <td>
                              <label for="pack3-tv-equipment-3">
                                <a href="" class="tooltip above">Enhanced DVR Box
                                  <span class="tooltip-text">Record up to six shows simultaneously with our latest DVR. You can save up to 150 hours of HD shows - that's an increase of two to six times more storage from older DVRs.</span>
                                </a>
                              </label>
                            </td>
                            <td class="price">
                    ...
                    <div class="productSelect">
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <input id="pack3-internet-equipment-1" name="pack3-internet-equipment" type="radio">
                            </td>
                            <td>
                              <label for="pack3-internet-equipment-1">
                                <a href="" class="tooltip above">Internet Modem
                                  <span class="tooltip-text">Includes Home WiFi - pay for Wireless Gateway only ($8/mo).  Set up a wireless home network and connect multiple WiFi-enabled devices to the Internet over one superfast wireless connection. </span>
                                </a>
                              </label>
                          ...
                          <tr>
                            <td>
                              <input id="pack3-internet-equipment-2" name="pack3-internet-equipment" type="radio" checked>
                            </td>
                            <td>
                              <label for="pack3-internet-equipment-2">
                                <a href="" class="tooltip above">Wireless Gateway with Free Home WiFi
                                  <span class="tooltip-text">Includes Home WiFi - pay for Wireless Gateway only ($8/mo).  Set up a wireless home network and connect multiple WiFi-enabled devices to the Internet over one superfast wireless connection.</span>
                                </a>
                              </label>
                          ...
                          <tr>
                            <td>
                              <input id="pack3-internet-equipment-4" name="pack3-internet-equipment" type="radio">
                            </td>
                            <td>
                              <label for="pack3-internet-equipment-4">
                                <b>I'll use my own modem</b>
                              </label>
                            </td>
                            <td class="price">
                    ...
                    <div class="priceTally">
                      <table>
                        ...
                        <tr>
                          <td class="b">Charges reflected in your cart</td>
                          <td class="b">Total</td>
                          <td class="b price total">$97.99</td>
                        </tr>
                      </table>
                    </div>
                    <div class="text-center">
                      ...
                      <p class="b">You will have an opportunity to review your selections before placing your order.</p>
                      <div class="cta green icon-after icon-angle-right">
                        <a href="https://www.timewarnercable.com/residential/order?qso=TESTTP8999">
                          <span>Checkout</span>
                        </a>
                      </div>
                    </div>
                ...
                <div class="detailsContent">
                  <div class="vertical bulleted">
                    <ul>
                      <li class="listHead">Includes:</li>
                      <li>
                        <a href="" class="tooltip above">HD Box <span class="tooltip-text">Watch programming in high definition and digital programming with amazing picture quality and digital sound.</span></a> and <a href="" class="tooltip above">EPIX&reg; <span class="tooltip-text">Stream 3,000+ BIG Hollywood hit movies, concerts, comedy specials & originals. Watch everything uncut & commercial-free on your computer, tablet, smartphone & game console. </span></a>
                      </li>
                      <li>
                        <a href="" class="tooltip above">TWC TV&copy; <span class="tooltip-text">Watch live TV on your tablet, computer or smartphone from any room in your home.</span></a> and <a href="" class="tooltip above">Start Over&copy; <span class="tooltip-text">Restart a show that’s already in progress.</span></a>
                      </li>
                       <li>
                       <a href="" class="tooltip above">Home WiFi <span class="tooltip-text">Includes Home WiFi - pay for Wireless Gateway only ($8/mo).  Set up a wireless home network and connect multiple WiFi-enabled devices to the Internet over one superfast wireless connection.  </span></a>
                      </li>
                      ...
                      <li>
                        <a href="" class="tooltip above">Unlimited Calling <span class="tooltip-text">Unlimited calls to the U.S., Canada, Mexico, China, Hong Kong, India and U.S. territories.</span></a> and Voicemail
                      </li>
                    </ul>
                  </div>
                </div>
