...
<!--CONTENT--> 
<div class="sbsCompare packageSelect sticky">
    <!--PACKAGE 1 BEGIN-->       
 ...
 <!--PACKAGE 3 END-->
    ...
    <div class="sbsCompare packageSelect stickyElement">
        <div class="stickySpacing"></div>
 <!--PACKAGE DETAILS 1 START-->
        <div class="package packageBody">
              <hr>
        ...
        <!--PACKAGE DETAILS 1 END-->
        <!--PACKAGE DETAILS 2 START-->
        <div class="package packageBody">              
              <hr>
              <div class="quickCheckoutWrapper">
                <div class="quickCheckoutAccordion">
        ...
        <!--PACKAGE DETAILS 2 END-->
        <!--PACKAGE DETAILS 3 START-->
        <div class="package packageBody">              
              <hr>
              <div class="quickCheckoutWrapper">
                <div class="quickCheckoutAccordion">
