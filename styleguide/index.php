...
<div class="style-guide">
    ...
    <ul>
        <li>Small: Up to 640px or 40em</li>
        <li>Medium: 640px - 768px or 48em</li>
        <li>Large: 769px+</li>
    </ul>
	</div>
	...
	<div class="styleguide-cta">
		<div class="cta flatOmega styleguide-expand icon-after icon-angle-down">
		  <a href="">
		    <span>Expand This</span>
		  </a>
		</div>
		<div class="cta flatOmega twc-icon-after icon-angle-right">
	...
	<div class="styleguide-cta">
		...
		<div class="cta flatOmega twc-icon-after icon-angle-right right">
	...
	<span class="h2 jumpTo-anchor" id="case-treatment">Case Treatment</span>
	<div class="styleguide-cta">
		<div class="cta flatOmega styleguide-expand icon-after icon-angle-down">
		  <a href="">
		    <span>Expand This</span>
		...
		<div class="cta flatOmega twc-icon-after icon-angle-right right">
			<a href="/TWC/support/components/caseTreatment">
				<span>See this</span>
			</a>
		</div>
	</div>
	<hr>
	<div class="showContent">
		<?php include($_SERVER['DOCUMENT_ROOT']. '/TWC/support/components/caseTreatment/index.php'); ?>
		<hr class="divider-shadow" />
	</div>
